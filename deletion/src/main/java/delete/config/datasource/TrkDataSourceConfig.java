...
@EnableJpaRepositories(
        entityManagerFactoryRef = "trkEntityManagerFactory",
...
public class TrkDataSourceConfig {
    ...
    @Bean(name = "trkEntityManagerFactory")
    ...
    public PlatformTransactionManager trkTransactionManager(@Qualifier("trkEntityManagerFactory") EntityManagerFactory entityManagerFactory) {
